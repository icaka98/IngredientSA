...
from custom_models.TfidfEmbeddingVectorizer import TfidfEmbeddingVectorizer
...
if __name__ == '__main__':
    ...
    pipeline = Pipeline([
        ('w2v tfidf', TfidfEmbeddingVectorizer(w2v_model)),
    ...
    pickle.dump(pipeline, open('../models/word2vec_tfidf_model.sav', 'wb'))
